...
test.describe('Admin Flow (Real Backend)', () => {
    ...
    test('Zero to Hero: Full Lifecycle', async ({ page, testDb, authToken }) => {
        ...
        const statements = [
            {
                code: 'S1',
                translations: [{ language_code: 'en', text: 'Statement 1: Research is vital.' }],
            },
            {
                code: 'S2',
                translations: [
            ...
            {
                code: 'S4',
                translations: [{ language_code: 'en', text: 'Statement 4: Testing is essential.' }],
            },
            {
                code: 'S5',
                translations: [
            ...
            {
                code: 'S6',
                translations: [{ language_code: 'en', text: 'Statement 6: Privacy is a right.' }],
            },
            {
                code: 'S7',
                translations: [{ language_code: 'en', text: 'Statement 7: Speed is a feature.' }],
            },
        ];
