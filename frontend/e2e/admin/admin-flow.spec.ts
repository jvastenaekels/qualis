...
test.describe('Admin Flow (Real Backend)', () => {
    ...
    test('Zero to Hero: Full Lifecycle', async ({ page, testDb, authToken }) => {
        ...
        const statements = [
            { code: 'S1', translations: [{ language_code: 'en', text: 'Statement 1: Research is vital.' }] },
            { code: 'S2', translations: [{ language_code: 'en', text: 'Statement 2: Open Source is the future.' }] },
            { code: 'S3', translations: [{ language_code: 'en', text: 'Statement 3: Documentation matters.' }] },
            { code: 'S4', translations: [{ language_code: 'en', text: 'Statement 4: Testing is essential.' }] },
            { code: 'S5', translations: [{ language_code: 'en', text: 'Statement 5: Community is strength.' }] },
            { code: 'S6', translations: [{ language_code: 'en', text: 'Statement 6: Privacy is a right.' }] },
            { code: 'S7', translations: [{ language_code: 'en', text: 'Statement 7: Speed is a feature.' }] },
        ];
        ...
        await testDb.updateStudy(authToken, slug, {
            ...
            translations: [{
                ...
                condition_of_instruction: 'Please sort these statements according to your agreement.',
            }],
        });
