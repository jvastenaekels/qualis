...
test.describe("Branding Configuration Testing", () => {
  test.describe("Logo Configuration", () => {
    ...
    test("API: Logo config saves correctly", async ({ testDb, authToken }) => {
      ...
      expect(study.branding.logo_url).toBe(
        "https://example.com/custom-logo.png",
      );
    });

    test("Participant: Logo appears on welcome page", async ({
      page,
      testDb,
      authToken,
    }) => {
    ...
    test("Validation: Invalid URL rejected", async ({ page }) => {
      ...
      await expect(
        page.locator("text=valid URL", { hasText: /valid.*url/i }),
      ).toBeVisible();
    });

    test("Edge Case: No logo shows default", async ({
      page,
      testDb,
      authToken,
    }) => {
  ...
  test.describe("Accent Color", () => {
    ...
    test("Admin: Can set accent color", async ({ page }) => {
      ...
      const colorInput = page.locator(
        'input[type="color"], input[name="accentColor"]',
      );
    ...
    test("Participant: Accent color applied", async ({
      page,
      testDb,
      authToken,
    }) => {
  ...
  test.describe("Partner Logos", () => {
    ...
    test("Participant: Partner logos displayed", async ({
      page,
      testDb,
      authToken,
    }) => {
      ...
      for (const partner of partners) {
        const logoAlt = new RegExp(partner.name, "i");
    ...
    test("Edge Case: Many partner logos", async ({
      page,
      testDb,
      authToken,
    }) => {
