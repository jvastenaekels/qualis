...
test.describe('Study Configurations', () => {
    ...
    test('Study with no presort steps should skip presort page', async ({ page, testDb, authToken }) => {
    ...
    test('Study with mandatory presort fields should require input', async ({ page, testDb, authToken }) => {
        const studyData = testDataBuilders.study({
    ...
    test('Study with Asymmetric Grid should render correctly', async ({ page, testDb, authToken }) => {
         const subGrid = [
             { score: -3, capacity: 1 },
             { score: -2, capacity: 2 },
             { score: -1, capacity: 3 },
    ...
    test('Study with email collection should show email input', async ({ page, testDb, authToken }) => {
        const studyData = testDataBuilders.study({
            postsort_config: {
    ...
    test('Study with interview consent should show checkboxes', async ({ page, testDb, authToken }) => {
        const minimalGrid = [{ score: 0, capacity: 3 }];
        const studyData = testDataBuilders.study({
            grid_config: minimalGrid,
            statements: testDataBuilders.statements(3),
