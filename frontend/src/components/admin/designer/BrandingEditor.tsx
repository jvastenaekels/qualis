                                ...
                                <div className="flex-1 space-y-3">
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <button
                                            ...
                                            className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-2xs font-black text-slate-500 hover:bg-slate-100 transition-colors shadow-sm border bg-white"
                                        >
