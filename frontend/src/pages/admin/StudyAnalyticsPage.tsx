...
const StudyAnalyticsPage = () => {
    const { dump } = useLoaderData() as {
        // biome-ignore lint/suspicious/noExplicitAny: loader data mismatch
        dump: any;
        slug: string;
    };
    ...
    // biome-ignore lint/suspicious/noExplicitAny: API dump typing is loose
    ...
    // biome-ignore lint/suspicious/noExplicitAny: accumulator type
    const deviceBreakdown = participants.reduce(
        (acc: any, p: any) => {
                            ...
                            <div className="mt-6 pt-6 border-t border-white/10">
                                ...
                                <div className="h-1.5 w-full bg-white/10 rounded-full overflow-hidden">
                                    <div
                                        ...
                                        style={{
                                            width: `${Math.min(100, (participants.length / 40) * 100)}%`,
                                        }}
                                    />
                                </div>
                            </div>
