...
## [0.7.5](https://github.com/jvastenaekels/qualis/compare/v0.7.4...v0.7.5) (2026-07-30)


### Features

* **demo:** make the first five minutes feel like someone was expecting you ([#353](https://github.com/jvastenaekels/qualis/issues/353)) ([5e2e722](https://github.com/jvastenaekels/qualis/commit/5e2e722685292111a3574fcc8fb2e6335be0b4fd))


### Bug fixes

* **a11y:** add cursor-pointer to the labels made clickable in task 3.6 ([49214d6](https://github.com/jvastenaekels/qualis/commit/49214d64921e3f0a4f510e49bb488011fbf85369))
* **a11y:** close out the unnamed-switch/checkbox class across pre-sort and tag pickers ([c205fe4](https://github.com/jvastenaekels/qualis/commit/c205fe4c3987fce43a1915cd288f7cb7b84a3d1d))
* **a11y:** compute real contrast for alpha-slate text, match &lt;textarea&gt; too ([dcb419a](https://github.com/jvastenaekels/qualis/commit/dcb419a9b00ec6210e7c0fe92ec7ad6878501967))
* **a11y:** convert the image-upload drag/drop zone to a native button ([d51875c](https://github.com/jvastenaekels/qualis/commit/d51875ca1b7fdc791699d74df40bec62a75269fa))
* **a11y:** convert the study-status step tile to a native button ([6129d6b](https://github.com/jvastenaekels/qualis/commit/6129d6b6da50cfc90a7840e62f94199fa2f8b040))
* **a11y:** delete the dead text-slate-300 class in the participant stepper ([0500243](https://github.com/jvastenaekels/qualis/commit/0500243653d6c25b4d7f53fac6c9157a7ad8484c))
* **a11y:** drop the Data table's last two inert per-row tab stops ([e38b7b4](https://github.com/jvastenaekels/qualis/commit/e38b7b46c5d995ba0f20a21dd4e0f3ec0e862fce))
* **a11y:** fix real contrast/heading defects and land the admin axe spec ([e03e37c](https://github.com/jvastenaekels/qualis/commit/e03e37c8d0975589187a4b9e5e4e025c62b167a7))
* **a11y:** fix real text-slate-400 contrast on the analysis history loading state ([6e753b2](https://github.com/jvastenaekels/qualis/commit/6e753b28d259cb37a7d76dd121fac733446e3c30))
* **a11y:** fix real text-slate-400 contrast on the analysis loading states ([dd2cda5](https://github.com/jvastenaekels/qualis/commit/dd2cda5029535e793ccec57d0161fa383f54e161))
* **a11y:** fix the SortableCard/CardStack watermark contrast, name two more textareas, drop three biome-ignores ([b60eca9](https://github.com/jvastenaekels/qualis/commit/b60eca955bd2f4508f4a650dbc5ea50cce885ad8))
* **a11y:** give access-rule switches accessible names ([6d5d28f](https://github.com/jvastenaekels/qualis/commit/6d5d28ff0012ea131b08eb18b6a5fd9cddc8c823))
* **a11y:** give the Data table's rows a keyboard path to their own action ([a777a08](https://github.com/jvastenaekels/qualis/commit/a777a088c2eb0d46163dd8da885879fa3d105431))
* **a11y:** keep the design lock escapable and describe it honestly ([d4af48d](https://github.com/jvastenaekels/qualis/commit/d4af48d991006a151b360291b0c596aeaad68c14))
* **a11y:** make dashboard study and concourse cards keyboard-operable ([85f5873](https://github.com/jvastenaekels/qualis/commit/85f58739ff3fa8e92fd58877e31907674bb95c41))
* **a11y:** make the Data table's status chips indicators, not buttons ([e6f5afb](https://github.com/jvastenaekels/qualis/commit/e6f5afbc452221ddf8ef483f1b32fbae99829f93))
* **a11y:** make the design lock a dismissible dialog with a read-only escape ([5309b98](https://github.com/jvastenaekels/qualis/commit/5309b98541c52af71d34eb4aa5a2f06c6cef80b8))
* **a11y:** make the gate enforceable and prove the axe rules run ([3ddd4e1](https://github.com/jvastenaekels/qualis/commit/3ddd4e15475e83f442f0146b680e087a6005930e))
* **a11y:** match controls by effective role, not by tag ([bf7cfdd](https://github.com/jvastenaekels/qualis/commit/bf7cfddd1e84b50e72178c9841f8526134019b51))
* **a11y:** move the dashboard card headings out of the card button ([c7c10a0](https://github.com/jvastenaekels/qualis/commit/c7c10a0daf1c676a2fdde54560a943f8b41ba689))
* **a11y:** name ConcourseDetailPage's filter, status and tag controls ([3535aa0](https://github.com/jvastenaekels/qualis/commit/3535aa05cc4f2933662b9b5dfd94679ad3eff3d1))
* **a11y:** name dnd-kit drag handles, memo title fields, and the SortableCard code watermark ([b9e87ad](https://github.com/jvastenaekels/qualis/commit/b9e87ad1a9dce6d2eeadcc411ca992dd03f7427a))
* **a11y:** name InteractiveDataView's pagination and menu controls ([57e1025](https://github.com/jvastenaekels/qualis/commit/57e1025576e264b26a8e81226c3a96622d81f68a))
* **a11y:** name InterfaceEditor and ProjectMembersPage controls ([e8c0791](https://github.com/jvastenaekels/qualis/commit/e8c07911a3a85a1433edf08f0537e12486f0fb43))
* **a11y:** name QSortEditor's inline-edit and grid-help controls ([50d7178](https://github.com/jvastenaekels/qualis/commit/50d7178962b463f180d109a5ad2f95bf1a37cbeb))
* **a11y:** name QuestionBuilder's delete/import/remove-option controls ([0e5b172](https://github.com/jvastenaekels/qualis/commit/0e5b172b8625119a13b46b65c6738981eb82eb63))
* **a11y:** name the AudioPlayer play/pause toggle ([5893b18](https://github.com/jvastenaekels/qualis/commit/5893b186a28898ee3245d5edaa34a82af85078c9))
* **a11y:** name the designer and concourse controls that had none ([205af59](https://github.com/jvastenaekels/qualis/commit/205af59f26909f80642f69ffa8c6866ef44f8f91))
* **a11y:** name the group-heading wrappers and their unnamed members ([14cbf55](https://github.com/jvastenaekels/qualis/commit/14cbf5509633476064167265c31a6918a16c9439))
* **a11y:** name the QSortEditor distribution-mode radiogroup ([1aaa596](https://github.com/jvastenaekels/qualis/commit/1aaa596f6b02d8891f227dd0125a7a4adea0a638))
* **a11y:** name the remaining unnamed switches on the post-sort email section ([65b751a](https://github.com/jvastenaekels/qualis/commit/65b751a5cadf784504adbf8386c28a2fff8ec6ed))
* **a11y:** name the seek slider; register AudioPlayer's audio.* keys ([f33c960](https://github.com/jvastenaekels/qualis/commit/f33c9602604d98dba9497ee4f6f74171549c2feb))
* **a11y:** name the seven per-row indicator TooltipTriggers ([5cd91b4](https://github.com/jvastenaekels/qualis/commit/5cd91b451f0795f9cef1f18268adea283416f689))
* **a11y:** name the single-instance designer/account controls ([bc2c665](https://github.com/jvastenaekels/qualis/commit/bc2c6654dd0d924428806a838c59cb4fa75c4338))
* **a11y:** pair BrandingEditor partner-name label with its input ([7c88bc3](https://github.com/jvastenaekels/qualis/commit/7c88bc34d1900f2fc89701a150826fdb87544de1))
* **a11y:** pair ConcourseDetailPage's Add Item / Bulk Import labels; fix the tag-picker heading ([8ecba38](https://github.com/jvastenaekels/qualis/commit/8ecba3879380c36d1ca1545df2d809ac719c2b50))
* **a11y:** pair ImportFromConcourseDialog code-prefix label with its input ([977cf12](https://github.com/jvastenaekels/qualis/commit/977cf126a5ac1e588c888e978e1c2298a6393ad4))
* **a11y:** pair InterfaceEditor's nav/terminology/step-help labels with their inputs ([7abdf9a](https://github.com/jvastenaekels/qualis/commit/7abdf9a50c7f1df5e09a8a574bb034a49723e33e))
* **a11y:** pair IntroductionEditor's language/objective/instructions/consent labels ([68a1ada](https://github.com/jvastenaekels/qualis/commit/68a1ada586d5116a64997565fb671663218ac982))
* **a11y:** pair PostSortConfigEditor add-column label with its select ([550ef89](https://github.com/jvastenaekels/qualis/commit/550ef8915092c1053cc824ca46907e2ae65cdb8a))
* **a11y:** pair ProcessStepEditor's title/description/color labels; fix the icon heading ([91b763c](https://github.com/jvastenaekels/qualis/commit/91b763ca7d7c3ac88545caca6f53d43031046eff))
* **a11y:** pair ProjectMembersPage invite-modal labels with their controls ([a1a8d2f](https://github.com/jvastenaekels/qualis/commit/a1a8d2fdab402e7503b801eb031a1a2823e0d7a4))
* **a11y:** pair QuestionBuilder's field labels; fix the scale/options group headings ([659a566](https://github.com/jvastenaekels/qualis/commit/659a5660d1ec5bf9fb9b90ebe0b5d42ad91ec1f1))
* **a11y:** pair Step1_Feedback's comment labels with their textareas ([00aec3a](https://github.com/jvastenaekels/qualis/commit/00aec3a3e287943c71abda6758dab8cfcce5b4bc))
* **a11y:** raise ProcessStepEditor's drag-handle icon to legible contrast ([8641df6](https://github.com/jvastenaekels/qualis/commit/8641df60e35411f188942c2678c866f1bc2e0fab))
* **a11y:** raise QuestionBuilder's delete/import/remove-option icons to legible contrast ([7fa53cd](https://github.com/jvastenaekels/qualis/commit/7fa53cdf020307cc09a49660ae31dfc40319588c))
* **a11y:** raise QuestionBuilder's drag-handle icon to legible contrast ([4effd33](https://github.com/jvastenaekels/qualis/commit/4effd33e32d41cbe096a6952b778de746f68039e))
* **a11y:** raise the admin's contrast floor to AA ([#338](https://github.com/jvastenaekels/qualis/issues/338)) ([d8e7b77](https://github.com/jvastenaekels/qualis/commit/d8e7b7789bc9639beaf79e5644266cf0033635a5))
* **a11y:** raise the analysis history separator dots to legible contrast ([00bbae1](https://github.com/jvastenaekels/qualis/commit/00bbae1c82af741c7b588f1218ef0c4375f74696))
* **a11y:** raise the delete-statement icon and convert the click-to-edit div ([a67e061](https://github.com/jvastenaekels/qualis/commit/a67e061ffb830e44c7968ae1c978e2f74923124e))
* **a11y:** raise the delete-step icon to legible contrast ([90c5af8](https://github.com/jvastenaekels/qualis/commit/90c5af89a22f369d0ae54089f81d95b19827fdbc))
* **a11y:** raise the remove-partner icon to legible contrast ([9bae201](https://github.com/jvastenaekels/qualis/commit/9bae201ca7e7f481d386114e08917546ca745d17))
* **a11y:** raise the remove-tip icon to legible contrast ([df292f0](https://github.com/jvastenaekels/qualis/commit/df292f07f534d24c153299692babb908fac9a423))
* **a11y:** raise the sortable column-header sort icons to legible contrast ([6c17e07](https://github.com/jvastenaekels/qualis/commit/6c17e07c2a8fe0a176d2afae5dee83decf0e15d7))
* **a11y:** re-review — single announcement channel, isolate stopPropagation ([be02c00](https://github.com/jvastenaekels/qualis/commit/be02c00c8e879a4b3827ff802c74f97a222c97d8))
* **a11y:** repair heading hierarchy and login form affordances ([860c745](https://github.com/jvastenaekels/qualis/commit/860c745fd31bbfb5ab88821a3e424d81c0175353))
* **a11y:** replace the concourse-item row's role=button div with a native label ([3143d01](https://github.com/jvastenaekels/qualis/commit/3143d013f5203a774d99a33e0480479ddbb6bce2))
* **a11y:** restore Firefox text selection on the click-to-edit control; raise the drag-handle icon contrast ([99f391c](https://github.com/jvastenaekels/qualis/commit/99f391ce6034f309cb536f13738ef6dbffe04967))
* **a11y:** reveal concourse row actions on keyboard focus ([b28eab9](https://github.com/jvastenaekels/qualis/commit/b28eab9b1114dd497139f084c957049279644099))
* **a11y:** review round — icon contrast, role="img" misuse, stopPropagation guard ([44cc625](https://github.com/jvastenaekels/qualis/commit/44cc625849cee84391e79149d342627b4e668cc2))
* **a11y:** turn ImportStudyDialog's error/warning labels into real headings ([2736a06](https://github.com/jvastenaekels/qualis/commit/2736a065a95d71bce0798159d12e92fe058136e8))
* **a11y:** turn RecruitmentPage's group headings into real text ([21ff89c](https://github.com/jvastenaekels/qualis/commit/21ff89c7ce120bb22c293fee33bc5675c816c3ca))
* **a11y:** use aria-disabled, not disabled, so read-only statement text stays selectable ([9880eca](https://github.com/jvastenaekels/qualis/commit/9880ecab1c57ae14d3f9a66f9f591d8d9411cc1e))
* **admin:** give the product one primary button colour (4.1) ([#345](https://github.com/jvastenaekels/qualis/issues/345)) ([c48883d](https://github.com/jvastenaekels/qualis/commit/c48883d5fa571f67bf8033689c99719f536c409d))
* **admin:** one date and time format, driven by the app's language ([#343](https://github.com/jvastenaekels/qualis/issues/343)) ([fd923b1](https://github.com/jvastenaekels/qualis/commit/fd923b16be1929e1962279cb77b226fe905435ee))
* **admin:** restore the sidebar/breadcrumb/title naming canon ([#348](https://github.com/jvastenaekels/qualis/issues/348)) ([d292fa0](https://github.com/jvastenaekels/qualis/commit/d292fa0baf19be4414cbe9a14426ba42089a6c43))
* **admin:** say each thing once (5.3) ([#347](https://github.com/jvastenaekels/qualis/issues/347)) ([c9797f6](https://github.com/jvastenaekels/qualis/commit/c9797f63f16465a83ecbb07ab5dc617cb84f0589))
* **admin:** size badges by their content, not by a clamp (6.9, 6.10, 6.11) ([#341](https://github.com/jvastenaekels/qualis/issues/341)) ([475a2c6](https://github.com/jvastenaekels/qualis/commit/475a2c6abf342d069c6cceba70696e38e3d862f9))
* **admin:** typographic floor, the frozen clear-date buttons, and charts mounting at zero size ([#337](https://github.com/jvastenaekels/qualis/issues/337)) ([f0fcdd2](https://github.com/jvastenaekels/qualis/commit/f0fcdd292b7ac3ad35ea43b8e9579c87e869e501))
* **analysis:** keep a recovery path when the post-commit fetch fails ([d2d8438](https://github.com/jvastenaekels/qualis/commit/d2d843852f3472b6728989d6dbe15bfde3c610cf))
* **analysis:** label factor voices from the study's own post-sort config ([77258e6](https://github.com/jvastenaekels/qualis/commit/77258e669aea9b6eb7cb0bdd15cfd9219388d9b3))
* **analysis:** label recordings with a human question name, not the DB key ([510919a](https://github.com/jvastenaekels/qualis/commit/510919a13395e8ba2d079aa5ee5c4c0ce92832c0))
* **analysis:** stop flagging the current run as a historical one ([2146dd4](https://github.com/jvastenaekels/qualis/commit/2146dd43d334908770a1e0f3bb66de705b43c869))
* **analysis:** tell the viewed run and the study's latest run apart ([2094324](https://github.com/jvastenaekels/qualis/commit/209432419e9806530f6ca494093185cde3a21d79))
* **analysis:** unify the "current run" signal and close two races (Task 1.4 review round 1) ([6608faf](https://github.com/jvastenaekels/qualis/commit/6608fafa261217058be00787b95d847f0d676c81))
* **compose:** make the database probe actually prove the app can connect ([#354](https://github.com/jvastenaekels/qualis/issues/354)) ([5354df0](https://github.com/jvastenaekels/qualis/commit/5354df06797a972308117684ec5c98d343134c1f))
* **concourse:** make the curation counter describe what the progress bar measures ([a90ed66](https://github.com/jvastenaekels/qualis/commit/a90ed66e5f287055077fa8f951388e05138b028e))
* **data:** move `use no memo` to the parent and add an E2E column-parity guard ([a6ef4a0](https://github.com/jvastenaekels/qualis/commit/a6ef4a0f027bf123290e11f9f41d1a72b4772671))
* **data:** render the language column header so table values match their labels ([cbf8dcc](https://github.com/jvastenaekels/qualis/commit/cbf8dccd1a0222bbe1997e18fefd3120d71df910))
* **designer:** guard the draft after a failed save, not just before one ([#339](https://github.com/jvastenaekels/qualis/issues/339)) ([3b32b55](https://github.com/jvastenaekels/qualis/commit/3b32b55e7d5b399f83743f7a5ebb9f94ad57df37))
* **dx:** check the configuration, not just that a config file exists ([#352](https://github.com/jvastenaekels/qualis/issues/352)) ([3333101](https://github.com/jvastenaekels/qualis/commit/33331015c52ad67d156844f4c620ab9844e72c30))
* **e2e:** mount the test router locally, and stop reporting success when it is absent ([#351](https://github.com/jvastenaekels/qualis/issues/351)) ([7d88bce](https://github.com/jvastenaekels/qualis/commit/7d88bce932fb1fe57ea8f981a6685bf4cadc44fa))
* **e2e:** sync AdminPage.login() with the renamed login submit button ([c710b34](https://github.com/jvastenaekels/qualis/commit/c710b34a5d22fbc596bb328f2cafb64e3dcae723))
* **e2e:** target the stat value by testid, not by DOM structure ([#336](https://github.com/jvastenaekels/qualis/issues/336)) ([50e1f8b](https://github.com/jvastenaekels/qualis/commit/50e1f8b88eafe01f325eb001b73264f772769656))
* **i18n:** align view_read_only with per-language glossary register (task 3.2 review round 1) ([1599d0e](https://github.com/jvastenaekels/qualis/commit/1599d0e9bee7001638a3cc7cc13f6ddb52f70534))
* **i18n:** correct register and language variants in Account settings email_locked message ([a57bac3](https://github.com/jvastenaekels/qualis/commit/a57bac317c4b44ed82b52d2c55b3f5136e6151f6))
* **i18n:** correct the Dutch pronoun in the Account settings email notice ([e9fce41](https://github.com/jvastenaekels/qualis/commit/e9fce417fa3afb68c115667cee7194546d88d513))
* **i18n:** give every t() key a home, and a gate that says so ([#342](https://github.com/jvastenaekels/qualis/issues/342)) ([f1689f1](https://github.com/jvastenaekels/qualis/commit/f1689f1d8aff0e69a4e42289676b67191d1f800b))
* **i18n:** replace the API-status note on Account settings with user-facing copy ([68aeb95](https://github.com/jvastenaekels/qualis/commit/68aeb955cb5551e3b8d1151ee127aa4fb7d60966))
* **i18n:** translate breadcrumb landmark, sidebar toggle, and tab scroll chevrons ([aba5f23](https://github.com/jvastenaekels/qualis/commit/aba5f23a6530abdc06b2b7eba4620b0eb6213222))
* **i18n:** translate DialogContent and SheetContent close buttons ([1403654](https://github.com/jvastenaekels/qualis/commit/14036545a0f04a51cd67da78858a1d966027f755))
* **i18n:** translate FactorCanvas's distinguishing-statement badge ([021831d](https://github.com/jvastenaekels/qualis/commit/021831d3d4e70d88db461ad9494e720869da949a))
* **i18n:** translate the curation counter in the seven missing locales ([5c08454](https://github.com/jvastenaekels/qualis/commit/5c084544901660d6b7a84cc2b0abcd73af3be4d4))
* **members:** render the owner role as a badge so it stays out of every dropdown ([69e86a9](https://github.com/jvastenaekels/qualis/commit/69e86a92ca7a0f67d4ef6c0a2fd81c787022ed05))
* **members:** show the email instead of a 'No Name' placeholder ([2fb3155](https://github.com/jvastenaekels/qualis/commit/2fb31557ef44afc1a23ac447d4daf809f82ab9c4))
* **members:** show the Owner label instead of an empty role select ([c61784e](https://github.com/jvastenaekels/qualis/commit/c61784e2db5dd0831ec498d7dcfdececb610a3bf))
* **participants:** resolve real question labels for post-sort audio ([24c5ff1](https://github.com/jvastenaekels/qualis/commit/24c5ff1cf9424f15bfaabdf633ac2f7667b312b5))
* **participants:** stop SurveyResponseTable leaking raw keys too ([1981a99](https://github.com/jvastenaekels/qualis/commit/1981a99409a8d2a8c7579e47d02f79962a8067fd))
* **release:** keep package-lock.json version in sync with releases ([64eeeaa](https://github.com/jvastenaekels/qualis/commit/64eeeaa77b021e90e92cbb5d4f53564ac77f151d))
* **routing:** serve the styled error page for unknown URLs ([58bdbcf](https://github.com/jvastenaekels/qualis/commit/58bdbcfd7bf69dc324c4299356ccb0dedf2a80f7))
* **scalingo:** stop the one-click deploy from shipping a known signing key ([#356](https://github.com/jvastenaekels/qualis/issues/356)) ([d9211c9](https://github.com/jvastenaekels/qualis/commit/d9211c9ba9032a829cff5fc83fc306514b9f6766))
* **ui:** fix SlugInput's padding formula and restore the lost prefix divider ([8ece843](https://github.com/jvastenaekels/qualis/commit/8ece84366f288daf99dc7d9f7117f567c7689ec1))
* **ui:** measure the slug prefix instead of hard-coding its padding ([0c7fc42](https://github.com/jvastenaekels/qualis/commit/0c7fc4280b01bfee0af6c496028f1ef4e535e4a9))


### Documentation

* **a11y:** correct refuted contrast readings in load-bearing comments ([ebdde4e](https://github.com/jvastenaekels/qualis/commit/ebdde4e64cf92224500f7eaf64213796eb23d3f0))
* add Task 2.4 and record the audio-label limitation ([2f34adf](https://github.com/jvastenaekels/qualis/commit/2f34adff74222658b134bfcac836ed899fae8219))
* add the admin UX remediation plan ([abf83b9](https://github.com/jvastenaekels/qualis/commit/abf83b9c3bb5507dbf46096e28f4f8d191b2bf40))
* add the task to teach the gate about role-bearing divs ([6d6c6aa](https://github.com/jvastenaekels/qualis/commit/6d6c6aad3c0139af2885a2dbacbb47f1eaaac0c0))
* correct the plan's Task 1.2 remedy after CI ([0bb46ee](https://github.com/jvastenaekels/qualis/commit/0bb46ee0243eb0d92ae609a5cc163c989a47ce5e))
* extend Task 5.2 with a key-existence check ([56b4147](https://github.com/jvastenaekels/qualis/commit/56b41475e604e49369789cc58e36d7677d0804ad))
* **plan:** close Phase 4 and record what it left behind ([#346](https://github.com/jvastenaekels/qualis/issues/346)) ([4825e41](https://github.com/jvastenaekels/qualis/commit/4825e41d7b433b8c8c449b26f947ae17bde6f165))
* **plan:** close Phase 5 and record what it left behind ([#350](https://github.com/jvastenaekels/qualis/issues/350)) ([99aed2e](https://github.com/jvastenaekels/qualis/commit/99aed2e8518c23582fbabc1484b3f32a13f2ceb4))
* **plan:** drop the resolved audio-label deferral and fix Deferred numbering ([a95cbf5](https://github.com/jvastenaekels/qualis/commit/a95cbf5e5d9be1ae6d4fa3a3b0fa5f36b9af0e16))
* **plan:** log task 4.4, added during execution from 4.2's review ([#344](https://github.com/jvastenaekels/qualis/issues/344)) ([816d01b](https://github.com/jvastenaekels/qualis/commit/816d01b56b34e64df649b37d6277da2a4a3c6f23))
* **readme:** lead with how to run Qualis, not with why it exists ([#355](https://github.com/jvastenaekels/qualis/issues/355)) ([bc864dc](https://github.com/jvastenaekels/qualis/commit/bc864dc863ab007f92fe2bc82211fe92bc03e8d3))
* record that the Data table's rows have no keyboard path ([70cf6cf](https://github.com/jvastenaekels/qualis/commit/70cf6cf65c65f9a0bc06c1315d530f8dfc18c829))
* record that the Data table's status chips should not be buttons ([d69e16f](https://github.com/jvastenaekels/qualis/commit/d69e16f6c807421891895864d46bac2b9885b018))
* record the a11y backlog and add a lint-gate task ([7fe2423](https://github.com/jvastenaekels/qualis/commit/7fe24236c9d8b4946cf1dd7b6ef25910dfb70349))
* retract the switch-label finding and add Task 3.6 ([f5530f3](https://github.com/jvastenaekels/qualis/commit/f5530f38d5124ee5130b34e8c8dec25fb1a469b5))
* write the tasks the label burn-down deferred to ([3b91991](https://github.com/jvastenaekels/qualis/commit/3b91991c95e3a336de5db7cfcc62db86c28338d3))

## [0.7.4](https://github.com/jvastenaekels/qualis/compare/v0.7.3...v0.7.4) (2026-07-25)
...
* **docs-check:** match demo-up's split build/health-wait form ([32df8df](https://github.com/jvastenaekels/qualis/commit/32df8df26115be8ed11db1dafd608ae53f024763))
* **hub:** show projects and cross-project studies on the Researcher Hub ([8f5516d](https://github.com/jvastenaekels/qualis/commit/8f5516dca5e2bb68c342148c2d49988ab7eddc60))
* **hub:** whitelist the new route handler for vulture ([8cfd5ab](https://github.com/jvastenaekels/qualis/commit/8cfd5abe37d8d683790ada02a0ad8701b33cda20))
...
* **security:** accept the brace-expansion DoS advisory (dev/write-only) ([#302](https://github.com/jvastenaekels/qualis/issues/302)) ([5e58b99](https://github.com/jvastenaekels/qualis/commit/5e58b990569cb93efdb173c046130e97cd821f5d))
...
* **deployment:** add an "Audio storage in production" decision guide ([040394e](https://github.com/jvastenaekels/qualis/commit/040394ed164d1ba79ba7f4999b0b0456f9464271))
