# GDPR controls reference for Qualis self-hosters

**Date:** 2026-05-03
**Audit ref:** comprehensive security audit, 2026-05-03 (dossier kept outside this repository)
**Status:** Exhaustive software-controls reference for operators. Not legal advice.

For an explanation of responsibilities, start with the
[GDPR responsibility model](../explanation/gdpr-responsibility-model.md). For
operational procedures, use the [GDPR operations guide](../guides/gdpr-operations.md).
