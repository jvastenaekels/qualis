...
This document outlines the coding standards and best practices for the Open-Q frontend, optimized for **React v19** and **Tailwind CSS**.
...
Open-Q is mobile-first. Ensure all complex interactions are optimized for touch.
