...
## Technology and interface mechanisms

The concrete runtime libraries and responsive-interface mechanisms are listed in the
...
The persistent entities, relationships, integrity constraints, and source locations
are documented in the [Data Model reference](../reference/data-model.md).
...
For the runtime defaults that fall out of these commitments (rate-limiting modes, connection pool sizing, security headers, error response shape), see the [Operations reference](../reference/operations.md) and [`../reference/api.md#error-response-format`](../reference/api.md#error-response-format).
